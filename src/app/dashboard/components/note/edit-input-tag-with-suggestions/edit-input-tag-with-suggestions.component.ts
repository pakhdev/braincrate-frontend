...
@Component({
    selector: 'edit-input-tag-with-suggestions',
    templateUrl: './edit-input-tag-with-suggestions.component.html',
})
export class EditInputTagWithSuggestionsComponent implements OnInit {
